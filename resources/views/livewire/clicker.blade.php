<div class="w-1/2 h-screen bg-gray-500">
    <div >
        @if(session('success'))
        ...
        <form action="" class="ml-2" wire:submit="createNewUser">
            ...
            <button type="button" wire:click.prevent="reloadList" class="block rounded px-3 py-1 border bg-gray-400 text-white mb-2">Create </button>
